"""
Django settings for frosty_grass_dev_107985 project.
...
ROOT_URLCONF = 'frosty_grass_dev_107985.urls'
...
WSGI_APPLICATION = 'frosty_grass_dev_107985.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_grass_dev_107985 API",
    "DESCRIPTION": "API documentation for frosty_grass_dev_107985 App",
    "VERSION": "v1",
}
